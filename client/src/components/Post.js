...
function Post({ post , postInProfilePage}) {
  ...
  return (
    <div className="bs1 p-2 mt-3">
      <div className="d-flex justify-content-between align-items-center">
        <div className="d-flex align-items-center">
          {post.user.profilePicUrl === "" ? (
            ...
            <img src={post.user.profilePicUrl} alt='IMG' height='35' width='35' style={{borderRadius:'50%'}}/>
          )}
      ...
      <img src={post.image} alt='IMG' style={{height: postInProfilePage===true && '200px'}} className="postimage w-100"/>
      ...
      >
        <Row>
          <Col lg={13} xs={0}>
            <img src={post.image} alt='IMG' height="400" className="w-100" />
          </Col>
          <Col lg={11} xs={24}>
            <TextArea
