              ...
              <div className="bs1 m-2 p-2 text-left">
                <div className="d-flex align-items-center">
                  {user.profilePicUrl === "" ? (
                    ...
                    <img src={user.profilePicUrl}  alt='IMG' height="60" width="60" />
                  )}
              ...
              return (
                <div className="d-flex align-items-center bs1 p-1 mt-2">
                  {followeruser.profilePicUrl === "" ? (
                    ...
                    <img
                      src={followeruser.profilePicUrl}  alt='IMG' 
                      height="35"
                      width="35"
                  ...
                  <div className='ml-2'>
                      <div style={{ margin : 2}}><span >{followeruser.username}</span></div>
              ...
              return (
                <div className="d-flex align-items-center bs1 p-1 m-2">
                  {followinguser.profilePicUrl === "" ? (
                    ...
                    <img
                      src={followinguser.profilePicUrl}  alt='IMG' 
                      height="35"
                      width="35"
                      style={{ borderRadius: "50%" }}
                    />
                  ...
                  <div className='ml-2'>
                      <div style={{ margin : 2}}><span>{followinguser.username}</span></div>
